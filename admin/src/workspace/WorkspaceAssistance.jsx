...
import ParticipantPage from '../assistance/ParticipantPage';
      ...
      <Layout style={{ height: '100%' }}>
          ...
          <Affix>
            <div>
              ...
              >
                ...
                <Menu.Item key="assistances">
                  <Link to="/assistances"><Icon type="file" />Assistances</Link>
                </Menu.Item>
        ...
        <Content style={{ backgroundColor: '#FFF' }}>
          <div>
            ...
            <Route exact path="/assistances" component={AssistancePage} />
