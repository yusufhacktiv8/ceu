...
import CompletedExportWindow from './CompletedExportWindow';

const { RangePicker } = DatePicker;

const COMPLETED_URL = `${process.env.REACT_APP_SERVER_URL}/api/reports/completedcourses`;
...
class CompletedList extends Component {
  ...
  fetchCourses() {
    ...
    axios.get(COMPLETED_URL, { params: {
