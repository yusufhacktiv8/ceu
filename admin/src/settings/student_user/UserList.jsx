...
const STUDENT_USERS_URL = `${process.env.REACT_APP_SERVER_URL}/api/studentusers`;
...
class UserList extends Component {
  ...
  fetchUsers() {
    ...
    axios.get(STUDENT_USERS_URL, { params: {
  ...
  deleteUser(user) {
    ...
    axios.delete(`${STUDENT_USERS_URL}/${user.id}`)
      .then(() => {
    ...
    return (
      <div>
              ...
              <Column
                ...
                render={(text, record) => (
                  <span>
                    ...
                    />
                    <Popconfirm
                      title={`Are you sure remove user ${record.User.name} from student ${record.Student.name}`}
        ...
        <UserWindow
          ...
          initialStudent={this.state.user ? this.state.user.Student : undefined}
