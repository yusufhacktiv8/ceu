...
class UserList extends Component {
  ...
  fetchUsers() {
    ...
    axios.get(HOSPITAL_USERS_URL, { params: {
  ...
  deleteUser(user) {
    ...
    axios.delete(`${HOSPITAL_USERS_URL}/${user.id}`)
      .then(() => {
              ...
              <Column
                ...
                render={(text, record) => (
                  <span>
                    ...
                    />
                    <Popconfirm
                      title={`Are you sure remove user ${record.User.name} from hospital ${record.Hospital.name}`}
