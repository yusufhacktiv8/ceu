...
const MIDKOMPRE_CANDIDATE_URL = `${process.env.REACT_APP_SERVER_URL}/api/reports/yudisiumcandidates`;
const Column = Table.Column;

class MidKompreCandidateList extends Component {
  state = {
    searchText: '',
    preTests: [],
    selectedRowKeys: [],
  ...
  fetchMidKompreCandidates() {
    ...
    axios.get(MIDKOMPRE_CANDIDATE_URL, { params: {
  ...
  confirmDelete = () => {
    ...
    const onOk = () => {
      const axiosObj = axios.put(`${MIDKOMPRE_CANDIDATE_URL}/removein`, { studentIds: selectedRowKeys });
      axiosObj.then(() => {
...
export default MidKompreCandidateList;
